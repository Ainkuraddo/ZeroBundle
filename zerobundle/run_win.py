...
if __name__ == "__main__":
    ...
    wndClass.lpszClassName = "Ainkuraddo"
    ...
    hWnd = ctypes.windll.user32.CreateWindowExW(0, u"Ainkuraddo", u"Ainkuraddo", WS_POPUP | WS_VISIBLE | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, (screenWidth / 2) - (width / 2), (screenHeight / 2) - (height / 2), width, height, 0, 0, 0, 0)
    if hWnd == 0:
        exit()
